...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-gray-200 pb-4">
        ...
        <a href="{{ url('/admin/dashboard') }}" class="text-gray-500 hover:text-[#D32F0F] font-medium transition flex items-center gap-2">
            <i class="fa-solid fa-arrow-left"></i> Kembali
        </a>
    </div>

    <form action="#" method="POST" enctype="multipart/form-data" class="flex flex-col lg:flex-row gap-6">
        @csrf
        ...
        <div class="w-full lg:w-2/3 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <input type="text" name="judul" placeholder="Masukkan judul artikel..." class="w-full border border-gray-300 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#D32F0F] text-lg font-medium transition" required>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-[500px]">
                ...
                <div class="bg-gray-50 border-y border-gray-200 px-4 py-2 flex flex-wrap gap-2 items-center">
                    ...
                    <div class="w-px h-5 bg-gray-300 mx-1"></div>
                    <button type="button" class="w-8 h-8 rounded hover:bg-gray-200 text-gray-700 transition"><i class="fa-solid fa-link"></i></button>
                    <button type="button" class="w-8 h-8 rounded hover:bg-gray-200 text-gray-700 transition"><i class="fa-regular fa-image"></i></button>
                </div>

                <textarea name="konten" placeholder="Tulis isi artikel di sini..." class="w-full flex-grow p-6 focus:outline-none resize-none leading-relaxed text-gray-700" required></textarea>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="relative">
                        <select name="kategori" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D32F0F] appearance-none bg-white pr-10 cursor-pointer" required>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:bg-gray-50 hover:border-[#D32F0F] transition cursor-pointer group">
                    ...
                    <p class="text-sm font-bold text-gray-700">Klik atau Drag foto ke sini</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col gap-3">
                <button type="submit" class="w-full bg-[#D32F0F] hover:bg-red-700 text-white font-bold py-3 rounded-xl shadow-md hover:shadow-lg transition flex items-center justify-center gap-2">
                    <i class="fa-solid fa-paper-plane"></i> Publikasikan Sekarang
                </button>
                <button type="button" class="w-full bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-bold py-3 rounded-xl transition">
                    Simpan sebagai Draf
                </button>
            </div>
