...
@section('content')
    <div class="mb-8">
        <h1 id="greeting-text" class="text-3xl md:text-4xl font-bold text-[#D32F0F]">Memuat data...</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div id="ongoing-card" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col gap-4 hover:shadow-md transition duration-300">
                <div class="flex justify-between items-start">
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h3 id="ongoing-judul" class="font-bold text-xl text-gray-800">Memuat...</h3>
                            <p id="ongoing-deskripsi" class="text-gray-500 text-sm mt-1 leading-relaxed max-w-lg">
                ...
                <div class="flex justify-between items-center mt-2 border-t pt-4">
                    <div class="flex items-center gap-2 text-gray-500 text-sm">
                        ...
                        <span>Sedang ditangani oleh petugas</span>
                    </div>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-5">
                ...
                <div class="flex items-center gap-4">
                    <div id="angka-total" class="w-14 h-14 rounded-2xl bg-blue-50 text-blue-500 flex items-center justify-center text-2xl font-bold border border-blue-100">
                        -
                    </div>
                ...
                <div class="flex items-center gap-4">
                    <div id="angka-proses" class="w-14 h-14 rounded-2xl bg-orange-50 text-orange-500 flex items-center justify-center text-2xl font-bold border border-orange-100">
                        -
                    </div>
                ...
                <div class="flex items-center gap-4">
                    <div id="angka-selesai" class="w-14 h-14 rounded-2xl bg-green-50 text-green-500 flex items-center justify-center text-2xl font-bold border border-green-100">
                        -
                    </div>
