        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden md:flex space-x-10">
                    <a href="{{ url('/dashboard') }}" class="text-lg {{ request()->is('dashboard') ? 'font-bold border-b-[3px] border-white pb-1' : 'font-medium text-white/80 hover:text-white hover:border-b-[3px] hover:border-white/50 pb-1 transition-all' }}">
                        Dashboard
                    </a>
                    <a href="{{ url('/lapor') }}" class="text-lg {{ request()->is('lapor') ? 'font-bold border-b-[3px] border-white pb-1' : 'font-medium text-white/80 hover:text-white hover:border-b-[3px] hover:border-white/50 pb-1 transition-all' }}">
                        Lapor
                    </a>
                    <a href="{{ url('/riwayat') }}" class="text-lg {{ request()->is('riwayat') ? 'font-bold border-b-[3px] border-white pb-1' : 'font-medium text-white/80 hover:text-white hover:border-b-[3px] hover:border-white/50 pb-1 transition-all' }}">
                        Riwayat
                    </a>
                    <a href="{{ url('/edukasi') }}" class="text-lg {{ request()->is('edukasi') ? 'font-bold border-b-[3px] border-white pb-1' : 'font-medium text-white/80 hover:text-white hover:border-b-[3px] hover:border-white/50 pb-1 transition-all' }}">
                        Edukasi
                    </a>
                </nav>
